...
export function SchedulesMetricsSkeleton(): React.JSX.Element {
  return (
    <DashboardMetrics>
      {[1, 2, 3].map((i) => (
        <div
      ...
      <div className="ml-auto flex items-center gap-2">
        <div className="h-8 w-24 bg-outline-variant/20 rounded animate-pulse" />
        <div className="h-8 w-28 bg-outline-variant/20 rounded animate-pulse" />
      </div>
    </DashboardMetrics>
  );
}
