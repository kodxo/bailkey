...
export default function PostDetailPage() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-[120px] pb-xl px-gutter md:px-xl max-w-7xl mx-auto w-full">
        {/* Article Header */}
        <header className="mb-xl max-w-4xl">
          ...
          <div className="flex items-center space-x-4">
            ...
            />
            <div>
              <div className="font-h3 text-h3 text-on-surface">Jean-Marc Laurent</div>
        ...
        <div className="flex flex-col lg:flex-row gap-xl">
          ...
          <article className="lg:w-2/3 max-w-3xl prose prose-slate">
            ...
            <blockquote className="my-8 pl-6 border-l-4 border-primary bg-surface-container-low p-6 font-h3 text-h3 text-on-surface italic shadow-sm relative overflow-hidden">
              "La véritable rentabilité ne naît pas seulement de l'acquisition de
              nouveaux actifs, mais de la maîtrise absolue des flux opérationnels
              existants."
            </blockquote>
            <p className="font-body-md text-body-md text-on-surface-variant mb-6">
            ...
            <div className="bg-surface-container p-8 my-8 border border-outline-variant shadow-sm">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant">
                L'intégration d'Odoo 19 permet une réduction moyenne de 22% des
                coûts de traitement administratif lors de la première année
                d'implémentation.
              </p>
            </div>
          </article>
